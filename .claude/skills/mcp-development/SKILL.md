...
```bash
vendor/bin/sail artisan make:mcp-tool ToolName
vendor/bin/sail artisan make:mcp-resource ResourceName
vendor/bin/sail artisan make:mcp-prompt PromptName
vendor/bin/sail artisan make:mcp-server ServerName
```
...
```bash
vendor/bin/sail artisan mcp:inspector mcp/my-server  # Web server

vendor/bin/sail artisan mcp:inspector my-server      # Local server
