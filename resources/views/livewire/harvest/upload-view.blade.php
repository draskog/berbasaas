                ...
                <div class="space-y-6">
                    ...
                    <flux:table :paginate="$this->perPage > 0 ? $this->stagingRecords : null" pageName="staging_page">
                        <flux:table.columns>
                            ...
                            <flux:table.column class="hidden md:table-cell">{{ __('Gross (kg)') }}</flux:table.column>
                            <flux:table.column class="hidden md:table-cell">{{ __('Harvester #') }}</flux:table.column>
                        ...
                        <flux:table.rows>
                            @forelse($this->stagingRecords as $record)
                                <flux:table.row>
                                    ...
                                    <flux:table.cell class="hidden md:table-cell">{{ number_format($record->tare, 3, ',', '.') }}</flux:table.cell>
                                    <flux:table.cell class="hidden md:table-cell">{{ number_format($record->gross, 3, ',', '.') }}</flux:table.cell>
            ...
            <flux:tab.panel name="harvest">
                <div class="space-y-6">
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-2 sm:gap-4">
                        <flux:input type="search" size="sm" wire:model.live.debounce.300ms="search" placeholder="{{ __('Search by harvester number or name...') }}" icon="magnifying-glass" class="w-full sm:w-72!"/>
                        <flux:select wire:model.live="perPage" size="sm" class="w-28">
                            <flux:select.option value="25">25</flux:select.option>
                            <flux:select.option value="50">50</flux:select.option>
                            <flux:select.option value="100">100</flux:select.option>
                    ...
                    <flux:table :paginate="$this->perPage > 0 ? $this->harvestRecords : null" pageName="harvest_page">
                        <flux:table.columns>
                            ...
                            <flux:table.column class="hidden lg:table-cell">{{ __('Corrected') }}</flux:table.column>
                        </flux:table.columns>
